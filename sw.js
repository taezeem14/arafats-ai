...
<body>
  <div class="card">
    ...
    <p>Arafat-Ai can still load your locally saved chat history. AI generation needs internet and resumes automatically when back online.</p>
  </div>
</body>
</html>
`;
